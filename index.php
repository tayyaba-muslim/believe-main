...
.cos-type ul li::before{
    ...
    font-family:"font Awsome $ free"; 
          ...
          <div id="content"style= "background-color:black; color:white; margin-top: -80px;"> <!-- Content -->
                    ...
                    <div class = "container">
                        <div class= "row align-items-center">
                            <div class="col-lg-7 col-md-12 mb-lg-0 mb-5">
                                ...
                                <img src="images/index1.jpg" alt="" class="img-responsive" style="border: 5px solid white;border-radius: 0.625rem;" id="div-img">
                            ...
                            Colourpop and jenny Cosmetics is the price. Colourpop does not offer a “lip kit,” but their Ultra Matte Lipstick costs $6,
                             and a matching lip liner is an additional $5. Rather than spending $40.13 for a jenny lip kit after shipping, somebody could
                              spend $16.32 for a Colourpop lip liner and matte liquid lip after shipping. Along with jenny Cosmetics, Colourpop’s ultra-matte
                               ...
                               <br>
                               <br>
                               <img src="images/index5.jpg"id="div-img" alt=""class="img-responsive" style="border: 5px solid white;border-radius: 0.625rem;">

                    </div>
                      <div class="col-lg-7 col-md-12">
                        <div class="card border-0">
                        <img src="images/index1.webp" id="div-img" alt=""class="img-responsive" style="border: 5px solid white;border-radius: 0.625rem;">
                        
                        <br>
                        <img src="images/index3.webp"id="div-img" alt="" class="img-responsive" style="border: 5px solid white;border-radius: 0.625rem;">
